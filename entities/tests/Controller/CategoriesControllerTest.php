...
class CategoriesControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[series]' => 'Testing',
            'category[documentals]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setSeries('My Title');
        $fixture->setDocumentals('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setSeries('Value');
        $fixture->setDocumentals('Value');
        ...
        $this->client->submitForm('Update', [
            'category[movies]' => 'Something New',
            'category[series]' => 'Something New',
            'category[documentals]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getSeries());
        self::assertSame('Something New', $fixture[0]->getDocumentals());
    }
